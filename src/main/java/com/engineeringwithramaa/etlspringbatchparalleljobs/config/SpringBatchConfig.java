package com.engineeringwithramaa.etlspringbatchparalleljobs.config;
...
import com.engineeringwithramaa.etlspringbatchparalleljobs.listener.JobListener;
import com.engineeringwithramaa.etlspringbatchparalleljobs.listener.ReadListener;
import com.engineeringwithramaa.etlspringbatchparalleljobs.listener.StepListener;
import com.engineeringwithramaa.etlspringbatchparalleljobs.listener.WriterListener;
import com.engineeringwithramaa.etlspringbatchparalleljobs.model.Item;
import com.engineeringwithramaa.etlspringbatchparalleljobs.batch.JobProcessor;
import com.engineeringwithramaa.etlspringbatchparalleljobs.batch.JobReader;
import com.engineeringwithramaa.etlspringbatchparalleljobs.batch.JobWriter;
...
public class SpringBatchConfig {
    ...
    public ItemWriteListener<Item> writeListener() {
        return new WriterListener<Item>();
    }
    ...
    public JobOperator jobOperator(JobRegistry jobRegistry) throws Exception {
        ...
        jobOperator.setJobLauncher(jobLauncher1());
    ...
    public void run1() {
        ...
        try {
            jobLauncher1().run(job1(), jobParameters);
        } catch (Exception ex) {
    ...
    public void run2() {
        ...
        JobParameters jobParameters = new JobParameters(confMap);
        try {
            jobLauncher1().run(job2(), jobParameters);
        } catch (Exception ex) {
            System.err.println(ex.getMessage());
        }
    }
    ...
    public void run3() {
        ...
        JobParameters jobParameters = new JobParameters(confMap);
        try {
            jobLauncher1().run(job3(), jobParameters);
        } catch (Exception ex) {
            System.err.println(ex.getMessage());
        }
    }
